...
import LeaveQuota from "../../components/LeaveQuota/LeaveQuota";
          ...
          <div className="user-detail-profile-container">
            ...
            <div className="profile-image">
              ...
              <div className="job-position">
                {user.job_title ? user.job_title : "No job found"}
              </div>
            </div>
        ...
        <div className="main-contents-container">
          ...
          <div className="main-content-tab">
            <button
              ...
              className={
                tabIndex === 1 ? " tab-btn btn-1 active-tab" : "tab-btn btn-1 "
              }
            >
              Attendance
            </button>
            ...
            <button
              ...
              className={
                tabIndex === 2 ? " tab-btn btn-2 active-tab" : "tab-btn btn-2 "
              }
            >
              Leave Quota
            </button>
            ...
            <button
              ...
              className={
                tabIndex === 3 ? " tab-btn btn-3 active-tab" : "tab-btn btn-3 "
              }
            >
              User Info
            </button>
          ...
          <div className="main-content-tab-contents">
            <div
              className={
                tabIndex === 1 ? "active-content" : "tab-content-1 tab-content"
              }
            >
              <AttendanceRecords />
            </div>
            <div
              className={
                tabIndex === 2 ? "active-content" : "tab-content-2 tab-content"
              }
            >
              <LeaveQuota />
            </div>
